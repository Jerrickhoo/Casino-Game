...
public class Lucky9 extends Game {
			...
			if (choice == 1) {
				if (currentPlayer.getBalance() <= 0) {
					...
					if (shownPlayerValue == 9) {
						...
						Transaction.log(currentPlayer.getUsername(), currentPlayer.getPlayerId(), "Lucky9", "BET", bet, this.balance);
						this.balance += bet * 3.0;
						currentPlayer.setBalance(this.balance);
						Transaction.log(currentPlayer.getUsername(), currentPlayer.getPlayerId(), "Lucky9", "WIN", bet * 3.0, this.balance);
						System.out.println();
						System.out.println("            ╔══════════════════════════════════════════════════════════╗");
				...
				if (payout > 0) {
					this.balance += payout;
					currentPlayer.setBalance(this.balance);
					Transaction.log(currentPlayer.getUsername(), currentPlayer.getPlayerId(), "Lucky9", "WIN", payout, this.balance);
					System.out.println("            ╔══════════════════════════════════════════════════════════╗");
					...
					this.balance += bet;
					currentPlayer.setBalance(this.balance);
					Transaction.log(currentPlayer.getUsername(), currentPlayer.getPlayerId(), "Lucky9", "PUSH", bet, this.balance);
				    System.out.println("            ╔══════════════════════════════════════════════════════════╗");
				    System.out.println("            ║                 PUSH — BET RETURNED                      ║");
				    System.out.println("            ╚══════════════════════════════════════════════════════════╝");
				} else {
					Transaction.log(currentPlayer.getUsername(), currentPlayer.getPlayerId(), "Lucky9", "LOSS", bet, this.balance);
					currentPlayer.setBalance(this.balance);
					System.out.println("            ╔══════════════════════════════════════════════════════════╗");
	...
	// Display only player's cards (dealer hidden)
	private void displayPlayerOnly(int[] player) {
		System.out.println();
		System.out.println("            ╔════════════════════════════════════════════════════════════╗");
		System.out.print("            ║  Player: ");
		for (int v : player)
	...
	private void displayPlayerWithOneDealer(int[] player, int[] dealer) {
		...
		if (dealer.length > 0) System.out.print("[" + dealer[0] + "] ");
