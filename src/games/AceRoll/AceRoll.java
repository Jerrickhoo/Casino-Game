...
public class AceRoll extends Game {
    ...
    private final double MINIMUMBET = 1.0;
    ...
    public boolean mainMenu() {
        ...
        System.out.println("                                                      ║ Player: "
                + String.format("%-36s", player.getUsername()) + " ║");
        System.out.println("                                                      ║ Balance: "
                + String.format("%-35s", Formatter.formatCurrency(player.getBalance())) + " ║");
        System.out.println(
                "                                                      ╚══════════════════════════════════════════════╝");
        System.out.println("");
        System.out.println(
    ...
    public void displayRules() {
        ...
        System.out.println(
                "                                                  ╠════════════════════════════════════════════════════════╣");
        System.out.println(
                "                                                  ║  1) Both players ante to start the round.              ║");
        System.out.println(
                "                                                  ║  2) Both roll all dice and see their own hand.         ║");
        System.out.println(
                "                                                  ║                                                        ║");
        System.out.println(
                "                                                  ║  3) BETTING PHASE 1:                                   ║");
        System.out.println(
                "                                                  ║     - You may CHECK / CALL / RAISE / FOLD.             ║");
        System.out.println(
                "                                                  ║     - You may also SORT your hand to view it easily    ║");
        System.out.println(
                "                                                  ║     - Opponent responds (CHECK / CALL / RAISE / FOLD). ║");
        System.out.println(
                "                                                  ║     - If someone folds, the other wins the pot.        ║");
        System.out.println(
                "                                                  ║                                                        ║");
        System.out.println(
                "                                                  ║  4) If both players are still in, you may REROLL       ║");
        System.out.println(
                "                                                  ║     any dice to try improving your hand.               ║");
        System.out.println(
                "                                                  ║                                                        ║");
        System.out.println(
                "                                                  ║  5) BETTING PHASE 2 (same rules as Phase 1).           ║");
        System.out.println(
                "                                                  ║                                                        ║");
        System.out.println(
                "                                                  ║  6) If nobody folds, hands are revealed and            ║");
        System.out.println(
                "                                                  ║     the higher hand wins the pot.                      ║");
        System.out.println(
                "                                                  ║                                                        ║");
        System.out.println(
    ...
    public void playRound(Player player) {
        ...
        if (!player.canAfford(MINIMUMBET)) {
            System.out.println(
                    "                                                  ╔════════════════════════════════════════════════════╗");
            System.out.println(
                    "                                                  ║    You need to have at least $1 to play a Round    ║");
            System.out.println(
                    "                                                  ╚════════════════════════════════════════════════════╝");
            System.out.println(
                    "                                                  ╔════════════════════════════════════════════════════╗");
        ...
        if (pre.folded) {
            ...
            if (pre.foldWinner == 1) {
                ...
                System.out.println(
                        "                                                  ╔═════════════════════════════════════════════════════════╗");
                System.out.println(
                        "                                                  ║   Opponent folded. You win the pot of "
                ...
                botBalance += pot;
                Transaction.log(player.getUsername(), player.getPlayerId(), "AceRoll", "Loss", -pot,
                        player.getBalance());
                System.out.println(
                        "                                                  ╔═════════════════════════════════════════════════════════╗");
                System.out.println(
                        "                                                  ║   You folded. Opponent wins the pot of "
        ...
        System.out.println(
                "                                                  ╔═════════════════════════════════════════════════════════════════════════════╗");
        System.out.print(
                "                                                    Enter dice positions to reroll (1-5, space-separated), or 0 to keep: ");
    ...
    public boolean checkBankrupt(Player player, double botBalance) {
        ...
        if (player.getBalance() <= 0.0) {
            ...
            System.out.println(
                    "                                              ╔═════════════════════════════════════════════════════════════════╗");
            System.out.println(
                    "                                              ║  You have no funds to start another round. Returning to lobby.  ║");
            System.out.println(
                    "                                              ╚═════════════════════════════════════════════════════════════════╝");
            ...
            System.out.println(
                    "                                              ╔═════════════════════════════════════════════════════════════════╗");
            System.out.println(
                    "                                              ║      Opponent has no funds to continue. Returning to lobby.     ║");
            System.out.println(
                    "                                              ╚═════════════════════════════════════════════════════════════════╝");
            InputValidator.waitForUserInput("                                              Press Enter to Continue");
            ConsoleDisplay.clearConsole();
